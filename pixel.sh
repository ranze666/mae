...
--use_pixel \
--pixel_loss_decay \
--output_dir ./output_dir/bootmae_pretrain/blr"$blr"_ema"$ema_decay_init"_featurelayer"$feature_layer"_ema_decay_final"$ema_decay_final"_warmup_epochs"$warmup_epochs"_ema_decay_warmup_epoch"$ema_decay_warmup_epoch"_pixel

CUDA_VISIBLE_DEVICES=0 python main_finetune.py \
--finetune ./output_dir/bootmae_pretrain/blr"$blr"_ema"$ema_decay_init"_featurelayer"$feature_layer"_ema_decay_final"$ema_decay_final"_warmup_epochs"$warmup_epochs"_ema_decay_warmup_epoch"$ema_decay_warmup_epoch"_pixel/checkpoint-199.pth \
